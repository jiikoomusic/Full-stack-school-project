...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['jpg', 'jpeg', 'png'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO hupparit (nimi, hinta, kuva, tuotetiedot) VALUES ('$_POST[hupparit]' , '$_POST[hinta]', '$filename', '$_POST[tuotetiedot]')";
...
if (isset($_GET['file_id'])) {
    ...
    $sql = "SELECT * FROM hupparit WHERE id=$id";
    $result = mysqli_query($conn, $sql);
    ...
    if (file_exists($filepath)) {
        ...
        $updateQuery = "UPDATE hupparit SET downloads=$newCount WHERE id=$id";
