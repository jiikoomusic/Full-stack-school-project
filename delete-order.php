...
<html lang="fi">
<title>ADMIN - tilaus poistettu</title>
...
<body>
	...
	<! Tähän päättyy navigointivalikko>	
            ...
            <! Tähän päättyy dropdown-menu>		
                ...
                if($_POST['tilaus_id']){
                    $qry = "DELETE FROM tilauslomake WHERE tilaus_id='$_POST[tilaus_id]'";
                ...
                <! Tähän päättyy php-toiminnallisuus>
                    ...
                    <div style="position: relative; top: 240px; left: 240px;" align="center" id="tilauspoistettu">
                    <br>
                    <h3>Tilaus poistettu!</h3> <br> <br>
